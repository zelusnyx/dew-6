...
export declare class FaLayersComponent implements OnInit, OnChanges {
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<FaLayersComponent, "fa-layers", never, { "size": "size"; "fixedWidth": "fixedWidth"; }, {}, never, ["fa-icon, fa-duotone-icon, fa-layers-text, fa-layers-counter"]>;
}
